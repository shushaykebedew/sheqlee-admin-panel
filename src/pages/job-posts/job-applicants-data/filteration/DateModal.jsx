...
import { JobApplicantsContext } from "../JobApplicantsData";
...
function DateModal({ isOpen, onClose }) {
  ...
  const { applyDateFilter } = useContext(JobApplicantsContext);
  ...
  const handleApplyFilters = () => {
    ...
    console.log("appapplyDateFilter function:", applyDateFilter);

    if (applyDateFilter) {
      applyDateFilter(startDate, endDate);
    } else {
      console.error("appapplyDateFilter is undefined");
    }
